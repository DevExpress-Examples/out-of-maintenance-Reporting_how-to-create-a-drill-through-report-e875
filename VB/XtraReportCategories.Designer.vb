Namespace Drill_through_example
	Partial Public Class XtraReportCategories
		...
		Private Sub InitializeComponent()
			...
			Dim navigateToReportAction1 As New DevExpress.XtraReports.Interactivity.NavigateToReportAction()
			...
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(XtraReportCategories))
