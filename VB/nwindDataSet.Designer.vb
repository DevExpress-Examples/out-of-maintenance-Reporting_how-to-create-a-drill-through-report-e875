...
Namespace DrillThroughReport
    ...
    Public Partial Class nwindDataSet
        ...
        Private tableCategories As DrillThroughReport.nwindDataSet.CategoriesDataTable
        ...
        Protected Sub New(ByVal info As Global.System.Runtime.Serialization.SerializationInfo, ByVal context As Global.System.Runtime.Serialization.StreamingContext)
            ...
            If(Me.DetermineSchemaSerializationMode(info, context) = Global.System.Data.SchemaSerializationMode.IncludeSchema) Then
                ...
                If(ds.Tables("Categories") IsNot Nothing) Then
                    MyBase.Tables.Add(New DrillThroughReport.nwindDataSet.CategoriesDataTable(ds.Tables("Categories")))
                End If
        ...
        Public Overrides Function Clone() As Global.System.Data.DataSet
            Dim cln As DrillThroughReport.nwindDataSet = CType((MyBase.Clone()), DrillThroughReport.nwindDataSet)
            cln.InitVars()
        ...
        Friend Sub InitVars(ByVal initTable As Boolean)
            Me.tableCategories = CType((MyBase.Tables("Categories")), DrillThroughReport.nwindDataSet.CategoriesDataTable)
        ...
        Private Sub InitClass()
            ...
            Me.tableCategories = New DrillThroughReport.nwindDataSet.CategoriesDataTable()
        ...
        Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
            Dim ds As DrillThroughReport.nwindDataSet = New DrillThroughReport.nwindDataSet()
        ...
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Delegate Sub CategoriesRowChangeEventHandler(ByVal sender As Object, ByVal e As DrillThroughReport.nwindDataSet.CategoriesRowChangeEvent)
        ...
        Public Partial Class CategoriesDataTable
            Inherits Global.System.Data.TypedTableBase(Of DrillThroughReport.nwindDataSet.CategoriesRow)
            ...
            Default Public ReadOnly Property Item(ByVal index As Integer) As CategoriesRow
                Get
                    Return CType((Me.Rows(index)), DrillThroughReport.nwindDataSet.CategoriesRow)
                End Get
            End Property

            <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
            Public Event CategoriesRowChanging As DrillThroughReport.nwindDataSet.CategoriesRowChangeEventHandler

            <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
            Public Event CategoriesRowChanged As DrillThroughReport.nwindDataSet.CategoriesRowChangeEventHandler

            <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
            Public Event CategoriesRowDeleting As DrillThroughReport.nwindDataSet.CategoriesRowChangeEventHandler

            <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
            Public Event CategoriesRowDeleted As DrillThroughReport.nwindDataSet.CategoriesRowChangeEventHandler

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
            Public Sub AddCategoriesRow(ByVal row As DrillThroughReport.nwindDataSet.CategoriesRow)
                Me.Rows.Add(row)
            End Sub
            ...
            Public Function AddCategoriesRow(ByVal CategoryName As String, ByVal Description As String, ByVal Picture As Byte()) As CategoriesRow
                Dim rowCategoriesRow As DrillThroughReport.nwindDataSet.CategoriesRow = CType((Me.NewRow()), DrillThroughReport.nwindDataSet.CategoriesRow)
            ...
            Public Function FindByCategoryID(ByVal CategoryID As Integer) As CategoriesRow
                Return CType((Me.Rows.Find(New Object() {CategoryID})), DrillThroughReport.nwindDataSet.CategoriesRow)
            End Function

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
            Public Overrides Function Clone() As Global.System.Data.DataTable
                Dim cln As DrillThroughReport.nwindDataSet.CategoriesDataTable = CType((MyBase.Clone()), DrillThroughReport.nwindDataSet.CategoriesDataTable)
                cln.InitVars()
                Return cln
            End Function
            ...
            Protected Overrides Function CreateInstance() As Global.System.Data.DataTable
                Return New DrillThroughReport.nwindDataSet.CategoriesDataTable()
            End Function
            ...
            Public Function NewCategoriesRow() As CategoriesRow
                Return CType((Me.NewRow()), DrillThroughReport.nwindDataSet.CategoriesRow)
            End Function

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
            Protected Overrides Function NewRowFromBuilder(ByVal builder As Global.System.Data.DataRowBuilder) As Global.System.Data.DataRow
                Return New DrillThroughReport.nwindDataSet.CategoriesRow(builder)
            End Function

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
            Protected Overrides Function GetRowType() As Global.System.Type
                Return GetType(DrillThroughReport.nwindDataSet.CategoriesRow)
            End Function
            ...
            Protected Overrides Sub OnRowChanged(ByVal e As Global.System.Data.DataRowChangeEventArgs)
                ...
                RaiseEvent CategoriesRowChanged(Me, New DrillThroughReport.nwindDataSet.CategoriesRowChangeEvent(CType((e.Row), DrillThroughReport.nwindDataSet.CategoriesRow), e.Action))
            End Sub
            ...
            Protected Overrides Sub OnRowChanging(ByVal e As Global.System.Data.DataRowChangeEventArgs)
                ...
                RaiseEvent CategoriesRowChanging(Me, New DrillThroughReport.nwindDataSet.CategoriesRowChangeEvent(CType((e.Row), DrillThroughReport.nwindDataSet.CategoriesRow), e.Action))
            End Sub
            ...
            Protected Overrides Sub OnRowDeleted(ByVal e As Global.System.Data.DataRowChangeEventArgs)
                ...
                RaiseEvent CategoriesRowDeleted(Me, New DrillThroughReport.nwindDataSet.CategoriesRowChangeEvent(CType((e.Row), DrillThroughReport.nwindDataSet.CategoriesRow), e.Action))
            End Sub
            ...
            Protected Overrides Sub OnRowDeleting(ByVal e As Global.System.Data.DataRowChangeEventArgs)
                ...
                RaiseEvent CategoriesRowDeleting(Me, New DrillThroughReport.nwindDataSet.CategoriesRowChangeEvent(CType((e.Row), DrillThroughReport.nwindDataSet.CategoriesRow), e.Action))
            End Sub

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
            Public Sub RemoveCategoriesRow(ByVal row As DrillThroughReport.nwindDataSet.CategoriesRow)
                Me.Rows.Remove(row)
            End Sub
        ...
        Public Partial Class CategoriesRow
            ...
            Friend Sub New(ByVal rb As Global.System.Data.DataRowBuilder)
                MyBase.New(rb)
                Me.tableCategories = CType((Me.Table), DrillThroughReport.nwindDataSet.CategoriesDataTable)
            End Sub
        ...
        Public Class CategoriesRowChangeEvent
            ...
            Private eventRow As DrillThroughReport.nwindDataSet.CategoriesRow

            Private eventAction As Global.System.Data.DataRowAction

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
            Public Sub New(ByVal row As DrillThroughReport.nwindDataSet.CategoriesRow, ByVal action As Global.System.Data.DataRowAction)
                Me.eventRow = row
...
Namespace DrillThroughReport.nwindDataSetTableAdapters
    ...
    Public Partial Class CategoriesTableAdapter
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.DrillThroughReport.Properties.Settings.[Default].nwindConnectionString
        End Sub
        ...
        Public Overridable Function Fill(ByVal dataTable As DrillThroughReport.nwindDataSet.CategoriesDataTable) As Integer
        ...
        Public Overridable Function GetData() As DrillThroughReport.nwindDataSet.CategoriesDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DrillThroughReport.nwindDataSet.CategoriesDataTable = New DrillThroughReport.nwindDataSet.CategoriesDataTable()
        ...
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(ByVal dataTable As DrillThroughReport.nwindDataSet.CategoriesDataTable) As Integer
        ...
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(ByVal dataSet As DrillThroughReport.nwindDataSet) As Integer
